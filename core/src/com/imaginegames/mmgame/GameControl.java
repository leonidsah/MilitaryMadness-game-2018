...
public class GameControl extends Game {
	...
	public static final String RELEASE = "0.4.5.1"; //0.4.1 Android release + new textures 0.4.1.3 - new texture for player and touch buttons, now events hidden in t/0.4.1.4 - bullets added compare with rockets
	// 0.4.2 - Optimization update: needed assetmanager/new buttons
	public static final String WELCOME_TITLE = "> Звуки на максимум! <";
