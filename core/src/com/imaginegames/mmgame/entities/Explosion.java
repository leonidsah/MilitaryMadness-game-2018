...
public class Explosion {
	...
	public Explosion (GameControl game, float firstRectX, float secondRectX, float firstRectWIDTH, float secondRectWIDTH, float firstRectY, float secondRectY, float firstRectHEIGHT, float secondRectHEIGHT, float EXPLOSION_SIZE) {
		this.game = game;
		...
		stateTime = 0;
		TextureRegion[][] animation_sheet = TextureRegion.split(game.assetManager.get("explosion_sheet.png", Texture.class), PWIDTH, PHEIGHT);
